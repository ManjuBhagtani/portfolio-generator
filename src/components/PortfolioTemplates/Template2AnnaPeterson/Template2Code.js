   ...
   <body class="home page-template page-template-onepage page-template-onepage-php page page-id-181 chrome windows elementor-default elementor-kit-530 elementor-page elementor-page-181">
      ...
      <header>
         <div class="header-left-part">
            ...
            <div class="site-title" title="Full name"> <a href="https://demo.cocobasic.com/teoro-wp/demo-1/"> ANNA PETERSON </a></div>
                                 ...
                                 <div class="elementor-column-wrap elementor-element-populated">
                                    <div class="elementor-widget-wrap">
                                       <div class="elementor-element elementor-element-3f957272 elementor-widget elementor-widget-heading" data-id="3f957272" data-element_type="widget" data-widget_type="heading.default">
                                          <div class="elementor-widget-container">
                                             <h1 class="elementor-heading-title elementor-size-default" title="Full name">Hello <br>I’m Anna <br>Peterson</h1>
                                          </div>
                                       </div>
                                                         ...
                                                         <div class="elementor-element elementor-element-52896c2 elementor-widget elementor-widget-text-editor" data-id="52896c2" data-element_type="widget" data-widget_type="text-editor.default">
                                                            <div class="elementor-widget-container">
                                                               <div class="elementor-text-editor elementor-clearfix">
                                                                  <p>
                                                                    <strong>NAME:</strong> <span title="Full name">Anna Peterson</span><br />
                                                                    <strong>CITY:</strong> <span title="Address">New York</span><br />
                                                                    <strong>PHONE:</strong> <span title="Phone number">(+123) 456 &#8211; 789</span><br />
                                                                    <strong>EMAIL:</strong> <span title="Email">anna@anna.com</span><br />
                                                                    <strong>WEBSITE:</strong> <span title="Website">www.yourwebsite.com</span></p>
                                                               </div>
                                                            </div>
                                                         </div>
                                                      </div>
                                                         ...
                                                         <div class="elementor-element elementor-element-4ec03c3a elementor-widget elementor-widget-image" data-id="4ec03c3a" data-element_type="widget" data-widget_type="image.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="elementor-image"> 
                                                                    <a href="https://demo.cocobasic.com/documentation/MANUAL-TeoroWP.pdf" target="_blank" rel="nofollow"> 
                                                                        <img width="400" height="360" src="https://demo.cocobasic.com/teoro-wp/demo-1/wp-content/uploads/2020/08/icon_download_cv.png" class="attachment-full size-full" alt="" loading="lazy" srcset="https://demo.cocobasic.com/teoro-wp/demo-1/wp-content/uploads/2020/08/icon_download_cv.png 400w, https://demo.cocobasic.com/teoro-wp/demo-1/wp-content/uploads/2020/08/icon_download_cv-300x270.png 300w" sizes="(max-width: 400px) 100vw, 400px" /> 
                                                                    </a>
                                                                </div>
                                                            </div>
                                                         </div>
                                                         <div class="elementor-element elementor-element-4f9bfd94 elementor-widget elementor-widget-heading" data-id="4f9bfd94" data-element_type="widget" data-widget_type="heading.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="elementor-heading-title elementor-size-default">
                                                                    <a href="https://demo.cocobasic.com/documentation/MANUAL-TeoroWP.pdf" target="_blank" rel="nofollow">DOWNLOAD CV</a>
                                                                </div>
                                                            </div>
                                                         </div>
                                                      </div>
                                             ...
                                             <ul class="timeline-holder">
                                                <li class="timeline-event">
                                                   ...
                                                   <div class="timeline-event-content">
                                                        <b title="Degree">BACHELOR OF SCIENCE</b> <br>
                                                        <span title="University/College">UNIVERSITY OF COLORADO BOULDER</span><br>
                                                        <span title="GPA">8.5/10</span><br>
                                                    </div>
                                                    <div class="timeline-event-date" title="End date">2018</div>
                                                </li>
                                                <li class="timeline-event">
                                                    <span class="timeline-circle"></span>
                                                    <div class="timeline-event-content">
                                                        <b title="Degree">TECHNOLOGY MAGNET PROGRAM</b> <br>
                                                        <span title="University/College">JAMES BUCHANAN HIGH SCHOOL</span><br>
                                                        <span title="GPA">8.5/10</span><br>
                                                    </div>
                                                    <div class="timeline-event-date" title="End date">2017</div>
                                                </li>
                                                <li class="timeline-event">
                                                    <span class="timeline-circle"></span>
                                                    <div class="timeline-event-content">
                                                        <b title="Degree">ABC Program</b> <br>
                                                        <span title="University/College">PQR HIGH SCHOOL</span><br>
                                                        <span title="GPA">8.5/10</span><br>
                                                    </div>
                                                    <div class="timeline-event-date" title="End date">2016</div>
                                                </li>
                                                <li class="timeline-event">
                                                    <span class="timeline-circle"></span>
                                                    <div class="timeline-event-content">
                                                        <b title="Degree">MNO Program</b> <br>
                                                        <span title="University/College">XYZ HIGH SCHOOL</span><br>
                                                        <span title="GPA">8.5/10</span><br>
                                                    </div>
                                                    <div class="timeline-event-date" title="End date">2015</div>
                                                </li>                                             
                                             </ul>
                                          </div>
                                       </div>
                                 ...
                                 <div class="elementor-column-wrap elementor-element-populated">
                                    <div class="elementor-widget-wrap">
                                       ...
                                       <div class="elementor-element elementor-element-6ef87128 elementor-widget elementor-widget-text-editor" data-id="6ef87128" data-element_type="widget" data-widget_type="text-editor.default">
                                          <div class="elementor-widget-container">
                                             <div class="elementor-text-editor elementor-clearfix"> © Mady by Anna Peterson </div>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
